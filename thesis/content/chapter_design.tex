...
This chapter summarizes the design of the recovery system (§\ref{section:RecoverySystemDesign}) developed for this thesis and its integration in the \gls{MegaL/Xtext} environment (§\ref{section:MegalXtextIntegrationDesign}).
