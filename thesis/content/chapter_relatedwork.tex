...
%\cite{Favre2004}
% not needed: paper is not really interested in trace link recovery
...
%\cite{DelukaFR2008}
% not needed in related work, the paper argues prospects of traceability for impact analysis, however it provides a nice traceability survey section
...
%\cite{Marcus2004}
% not needed, only refers to AntoniolCCDM00 and AntoniolCDLM99
